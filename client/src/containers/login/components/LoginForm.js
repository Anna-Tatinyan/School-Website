...
class LoginForm extends React.Component {
  ...
  inputValidator() {
    ...
    if (password && email) {
      ...
      const isButtonEnabled =
        validateEmail && !emptyPassword && !emptyEmail && passwordValidate;
  ...
  render() {
    ...
    this.props.error
      ? (requirementStatus = this.props.error.message)
      : (requirementStatus = this.state.validationWarning);
    return (
      <React.Fragment>
        <div
            ...
            >
              ...
              <div className="container-login100-form-btn">
                <button
                  ...
                  disabled={this.state.buttonIsEnabled}
                >
                  Login
                </button>
              </div>
