...
class TeacherForm extends React.Component {
    ...
    validate(input) {
      (!input.firstName) ? this.setState({
        firstNameError: "Last name is required"
      }): this.setState({
        firstNameError: ""
      });
      (!input.lastName) ? this.setState({
        lastNameError: "First name is required"
      }): this.setState({
        lastNameError: ""
      });
      (!input.phone) ? this.setState({
        phoneError: "Phone is required"
      }): this.setState({
        phoneError: ""
      });
      (!input.email) ? this.setState({
    ...
    render() {
        ...
        return ( <
          ...
          input ref = "firstName"
          defaultValue = {
            (inputValues) ? inputValues.firstName : ''
          }
          type = "text"
          id = "afname"
          name = "firstname"
          ...
          input ref = "lastName"
          defaultValue = {
            (inputValues) ? inputValues.lastName : ''
          }
          type = "text"
          id = "alname"
          name = "lastname"
